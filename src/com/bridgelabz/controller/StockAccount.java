...
public class StockAccount {
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
		...
		int customerId,companySymbol,numOfCompanyShareToBuy;
					...
					if (isCompanyFound) {
						...
						if (numOfCompanyShareToBuy < compList.get(indexOfCompany).getCompany_shares()) {
							...
							if (customerBalance > (numOfCompanyShareToBuy
								...
								compList.get(indexOfCompany).setCompany_total_value(compList.get(indexOfCompany).getCompany_share_price()
